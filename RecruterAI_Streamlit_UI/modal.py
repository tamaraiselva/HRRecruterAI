...
class Modal:
    def __init__(self, title, key, padding=20, max_width=744, height="auto", top_position="50px"):
        self.title = title
    ...
    def container(self):
        st.markdown(
            ...
            div[data-modal-container='true'][key='{self.key}'] > div > div:nth-child(2) > button {{
                margin-top: 0;
            }}
            </style>
            """,
...
def container(title=None, padding=20, max_width=None):
